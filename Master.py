...
frame1 = Frame(root, highlightbackground="blue", highlightthickness=1)
frame1.pack(padx=26, pady=34)
...
btn1 = Button(frame1, text="Login", fg="black", font=("4711_AtNoon_Regular", 16), bg="lightgrey",
              width="10", height="1", command=Login).pack()
...
#  ---------------------------- radiobutton fix posittion please fix your screen
    ...
    btnADD = Button(mainBooking, text="NEXT", fg="black", font=("4711_AtNoon_Regular", 12),
                    bg="lightgrey", width="20", height="3", command=MainProgress).grid(row=10, column=0, sticky='NSEW')
