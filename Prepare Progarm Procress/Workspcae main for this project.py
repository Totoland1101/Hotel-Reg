...
def booking():
  ...
  # สร้าง menu
    ...
    btnADD = Button(mainBooking, text="NEXT", fg="black", font=("4711_AtNoon_Regular", 12),
                    bg="lightgrey", width="20", height="3", command=test).grid(row=10, column=0, sticky='NSEW')
...
#                       bg="lightgrey", width="20", height="3", command=exitProgram1).grid(row=12, column=3, sticky='NSEW')
